  ...
  return (
    <div className="flex bg-custom-bg bg-no-repeat h-screen backdrop-blur-lg overflow-hidden">
      <div className="h-screen w-screen bg-custom rounded-cust">
        ...
        <h1 className="ml-52 mt-10 text-5xl font-bold text-white">
          New Contact
        </h1>
          ...
          <div className="container mx-auto">
            <form action="/contact" method="POST" onSubmit={create_contact}>
              ...
              <div className="ml-20 mt-2 flex">
                ...
                <div className="mt-4 ml-4 text-2xl text-white">
              ...
              <button className="ml-24 mt-8 text-white border border-solid text-xl border-white hover:bg-black px-8 py-2 rounded-full">
